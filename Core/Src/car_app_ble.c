...
uint16_t discovery_time 			= 0;
	...
	static uint8_t s_pTxNorthDirCharBuffer[6]			= {0x4E, 0x4F, 0x52, 0x54, 0x48, 0x00};
	static uint8_t s_pTxEastDirCharBuffer[6]			= {0x45, 0x41, 0x53, 0x54, 0x00, 0x00};
	static uint8_t s_pTxSouthDirCharBuffer[6]			= {0x53, 0x4F, 0x55, 0x54, 0x48, 0x00};
	static uint8_t s_pTxWestDirCharBuffer[6]			= {0x57, 0x45, 0x53, 0x54, 0x00, 0x00};
	static uint8_t s_pTxForceStopMovingCharBuffer[6]	= {0x42, 0x52, 0x41, 0x4B, 0x45, 0x53};
	static uint8_t s_pTxIncorrectMsgCharBuffer[6]		= {0x57, 0x52, 0x4F, 0x4E, 0x47, 0x00};
